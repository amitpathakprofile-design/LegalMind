  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        safe: "border-success/30 bg-success/20 text-success shadow-glow-success",
        "high-risk": "border-destructive/30 bg-destructive/20 text-destructive shadow-glow-danger",
